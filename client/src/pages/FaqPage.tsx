...
const faqs = [
  ...
  },
  {
    ...
    answer: "面對白髮困擾，許多人都會在「天然染髮」與「化學染髮」之間猶豫，不知道哪一種更適合自己。其實，兩者最大的差別就在於成分、對頭皮的影響，以及長期使用後的健康狀態。\n\n化學染髮的優點是上色快速、顏色選擇多樣，能在短時間內達到明顯的染髮效果。但許多化學染劑中含有阿摩尼亞、過氧化氫、PPD等刺激性成分，長期使用容易造成頭皮敏感、乾癢、泛紅，甚至讓頭皮受損。\n\n天然染髮則以植物性草本成分為主，像是天然馬鞭草、草本植物萃取等，透過溫和的方式進行染色。雖然顏色變化不像化學染髮那麼多，也需要較多時間累積效果，但對頭皮較溫和，更適合敏感性頭皮與重視健康養護的人。\n\n尤其對於需要長期遮蓋白髮的人來說，天然草本染髮不只是改變髮色，更是一種頭皮保養，透過染髮同時進行頭皮調理，減少刺激與負擔，讓頭皮維持健康穩定的狀態。\n\n選擇染髮，不只是選顏色，更是在選擇未來頭皮的健康。天然染髮與化學染髮各有其優缺點，重點在於找到最適合自己的方式。",
  },
  {
    question: "Q4：草本植物染多久做一次？",
    answer: "很多人在開始接觸天然植物染或草本頭皮護理時，常會問：\n\n「多久做一次比較適合？」\n\n沐璿的建議不是用固定週期套用每一位客人，而是先看客人的主要需求。\n\n一、如果主要需求是遮蓋白髮\n\n如果客人做天然植物染的主要目的，是整理新長出的白髮，並沒有固定一定要每幾週做一次。\n\n可以依照自己的白髮生長速度，以及自己希望整理髮色的時間來安排。\n\n有人大約 1 個月整理一次，也有人可能 3 個月甚至 6 個月再做一次。\n\n因此，白髮植物染的頻率可以依個人的白髮生長情況、外觀需求與生活習慣調整。\n\n二、如果主要需求是頭皮日常護理\n\n草本頭皮護理和快速型的染髮或護理概念不同，更重視依照個人的頭皮狀況，循序進行日常養護。\n\n例如有些客人平常容易有：\n\n• 頭皮出油\n• 頭皮癢\n• 頭皮屑較明顯\n• 頭皮容易敏感\n\n這類客人的護理頻率，可以依實際頭皮狀況與每次護理後的感受來調整。\n\n當頭皮狀況較穩定後，可以再依個人需求調整為大約每 1～3 個月一次，作為日常保養與維持，找到適合自己的護理頻率，才能真正讓頭皮回到健康、舒適的狀態。",
  },
  {
  ...
  },
  {
    ...
    answer: "為了讓白髮覆蓋效果更自然、更穩定，我們會根據每位顧客的需求，評估適合進行一種或兩種草本護理方式。大多數人只需做一次，通常約需 1.5 小時，內容包含頭皮狀況分析、天然草本調理、白髮覆蓋護理，以及專業的頭皮保養建議。這確保顏色、保養效果能達到理想效果。\n\n少數人需做第二次加強護理，時間同樣約為 1.5 小時，主要針對第一次護理後的狀況進行補強與穩定，讓草本染髮效果更持久，白髮覆蓋更完整，同時持續調理頭皮環境。",
  },
];
