        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          >
            <div className="text-muted-foreground space-y-5 leading-loose text-[15px] font-sans">
              <p>
                創辦人葉玉女，在新加坡生活的20年間，與草本文化結下了一段深厚的緣分，也開啟了她對「天然染白髮」的探索之路。在步入中年後，白髮開始悄悄出現。從最初幾根零星白髮，到逐漸影響整體氣色，她和許多女性一樣，開始面臨「染白髮」的需求。然而，她長期深受脂漏性皮膚炎影響，頭皮屑、頭皮癢反覆出現，始終不願意選擇傳統化學染劑染髮。
              </p>
              ...
              <blockquote className="border-l-4 border-primary/40 pl-5 py-1 my-6">
                <p className="font-serif text-lg font-bold text-foreground/80 italic leading-snug">
                  「難道想要遮蓋白髮，就一定要犧牲頭皮健康嗎？」
                </p>
              </blockquote>

              <p>
                在新加坡生活期間，她接觸到天然草本染髮文化，發現原來染白髮，也可以有更溫和、更安心的選擇。透過天然植物草本，不僅能自然覆蓋白髮，同時也能兼顧頭皮的保養。這樣的理念，讓她決定投入更多時間與心力，尋找真正適合自己的解決方式。
              </p>
              <p>
              ...
              <p className="font-medium text-foreground/70">
                對大多數客人而言，來到沐璿，初衷都是為了「染白髮」。但經過護理後，才發現原來染髮，也可以是一種保養。隨著新加坡市場逐漸穩定，創辦人葉玉女決定將這份結合「天然染白髮」與「頭皮護理」的成果帶回台灣，創立沐璿草本，讓更多人不必在美麗與健康之間做選擇。沐璿草本始終相信，真正好的染髮，不只是遮蓋白髮，而是讓人在每一次整理自己時，都能感受到安心、自信與被溫柔照顧。
              </p>
            </div>
          </motion.div>
        </div>
